...
public class OrderServiceImpl implements OrderService {
    ...
    public void saveOrderInfo(PayOrder po){
        payOrderDao.insert(po);
        System.out.println("----------------------- 保存parorder");
    }
    public void saveOrderRecord(PayOrderRecord por){
        payOrderRecordDao.insert(por);
        System.out.println("----------------------- 保存parorderRecord");
    }
